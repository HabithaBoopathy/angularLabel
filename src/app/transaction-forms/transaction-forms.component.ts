...
phone='';
  customerDetails() {
   console.log(this.everything.customerId)
    this.EmployeeService.getCustomerById(
      this.everything.customerId
    ).subscribe((data: Employee) => {
      ...
      this.mexecutiveService.getByExecutiveCode(data.executiveCode).subscribe(
        (data)=>{
           this.everything.executiveCode=data.id
  ...
  fetchTerritoryName(territoryId) {
    this.territoryService.getByTerritoryId(territoryId).subscribe((data) => {
      if (data != null) {
        this.everything.territoryId = data['name'];
  ...
  customerDetailsForCustomer() {
    this.EmployeeService.getCustomerEmail(
      ...
      this.everything.customerId = data.customerId;
      this.territoryIdtest = data.territory;
      this.fetchTerritoryName(this.territoryIdtest);
